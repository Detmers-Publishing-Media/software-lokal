...
Die App importiert `@codefabrik/vereins-shared/db` (Tauri SQL Plugin).
...
**Datei: `demo/browser-db-mock.js`** — Ersetzt `@codefabrik/vereins-shared/db`:
...
resolve: {
  alias: {
    '@codefabrik/vereins-shared/db': './demo/browser-db-mock.js',
    '@codefabrik/vereins-shared/components': './demo/mock-components.js',
  }
}
```
