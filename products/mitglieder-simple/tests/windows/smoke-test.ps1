...
$dbPath = Join-Path $env:APPDATA "de.detmers-publish.mitglieder-simple\mitglieder.db"
# Alternativ-Pfade pruefen
$dbPaths = @(
    $dbPath,
    (Join-Path $env:LOCALAPPDATA "de.detmers-publish.mitglieder-simple\mitglieder.db"),
